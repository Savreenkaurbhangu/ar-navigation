...
function render_elements() {
   $.ajax({
    ...
    success: function(response) {
        let images ={
            "turn_right": "assets/ar_left.png",
            "turn_left":"assets/ar_left.png",
            "slight_right":"assets/ar_slight_left.png",
            "slight_left":"assets/ar_slight_right.png",
        ...
        for (let i = 0; i < steps.length;i++) {
            ...
            if (i>0) {
                $("#scene_container").append(
                    `<a-entity
                    gps-entity-place="latitude: ${steps[i].maneuver[1]};
